...
function a() {
  return (
    (p === null || p.byteLength === 0) && (p = new Uint8Array(o.memory.buffer)),
    p
  );
}
...
function l(e, t, n) {
  ...
  if (c !== _) {
    (c !== 0 && (e = e.slice(c)),
      (r = n(r, _, (_ = c + e.length * 3), 1) >>> 0));
    const i = a().subarray(r + c, r + _),
      d = g.encodeInto(e, i);
...
class F {
  ...
  compileBatch(t) {
    const n = l(t, o.__wbindgen_malloc, o.__wbindgen_realloc),
      _ = f,
      r = o.querycompiler_compileBatch(this.__wbg_ptr, n, _);
    if (r[2]) throw w(r[1]);
    return w(r[0]);
  }
  constructor(t) {
    ...
    if (n[2]) throw w(n[1]);
    return (
      (this.__wbg_ptr = n[0] >>> 0),
      E.register(this, this.__wbg_ptr, this),
      this
    );
  }
  compile(t) {
    const n = l(t, o.__wbindgen_malloc, o.__wbindgen_realloc),
      _ = f,
      r = o.querycompiler_compile(this.__wbg_ptr, n, _);
    if (r[2]) throw w(r[1]);
    return w(r[0]);
  }
}
...
function k(e, t) {
  const n = String(t),
    _ = l(n, o.__wbindgen_malloc, o.__wbindgen_realloc),
    r = f;
...
function G(e, t) {
  ...
  (u().setFloat64(e + 8 * 1, x(_) ? 0 : _, !0),
    u().setInt32(e + 4 * 0, !x(_), !0));
}
function J(e, t) {
  const n = t,
    _ = typeof n == 'string' ? n : void 0;
  var r = x(_) ? 0 : l(_, o.__wbindgen_malloc, o.__wbindgen_realloc),
    s = f;
